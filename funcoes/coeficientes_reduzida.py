    ...
    if "(" in segundaParte and ")" in segundaParte:
        ...
        for parte in partes:
            ...
            try:
                ...
                for numero in parte:
                    # Tenta transformar em numero, a intenção dessa parte é
                    # encontrar a letra e retira-la do valor do coeficiente,
                    ...
                    try:
                        ...
                        if numero == "/" or numero == "." or numero == "-" or numero == "+":
                            coeficiente += numero
                # Tenta transformar o valor em um float,
                # caso não dê, supõe-se que temos problema na inserção da equação:
                try:
...
if __name__ == "__main__":
    ...
    print(main("y = - 3 x + 2 "))
    print(main("y = 3 x + 2 "))
    print(main("y = 3,2 x + 2.1 "))
    print(main("y = 3.1 x + 2,2 "))
    print(main("y = 3/2 x + 2/2 "))
    print(main("y = - 3.3/3 x - 2.2/2 "))

    print(main("y = ( 3 x - 2) / 2 "))
    print(main("y = ( 3 x - 2) * 2 "))
    print(main("y = ( - 3 x + 2) / 2 "))
    print(main("y = ( - 3 x + 2) * 2 "))
